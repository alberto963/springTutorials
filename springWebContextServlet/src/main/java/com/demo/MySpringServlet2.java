...
public class MySpringServlet2 extends FrameworkServlet {
	 ...
	 * Default constructor.
	 */
	public MySpringServlet2() {
		System.out.println("MySpringServlet2 constructor called");
	}
	...
	protected void initFrameworkServlet() throws ServletException, BeansException {
		...
		System.out.println("MySpringServlet2 initFrameworkServlet rootContext contains Bean_0="
				+ rootContext.containsBean("com.demo.rootContext.Bean_C0_0"));
		System.out.println("MySpringServlet2 initFrameworkServlet rootContext contains Bean_1="
				+ rootContext.containsBean("com.demo.rootContext.Bean_C1_0"));
		System.out.println("MySpringServlet2 initFrameworkServlet rootContext contains Bean_2="
